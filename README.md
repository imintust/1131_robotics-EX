...
####
🥇This training course utilizes two types of robots, EPSON and ABB. The EPSON robots are the primary ones used to develop manipulating skills and the final project for students. The ABB robot is only for learning machine vision in the second half of the semester. 
####
...
#### ME4609301 Mechanical Engineering Department, Taiwan-Paraquay Polytechnic University (Option ex: ABB Machine Vision)
#### SI5302701 Graduate Institute of Intelligent Manufacturing Tech., NTUST. (Option ex: Autonomous Mobile Robot, Jetbot)  
- Exercises:
  - Basic
  - Challenge
  - Assessment
